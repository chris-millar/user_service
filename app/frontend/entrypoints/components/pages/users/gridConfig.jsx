...
export const columns = [
  ...
  { field: 'email', headerName: 'Email', type: 'string', width: 225 },
  { field: 'profession', headerName: 'Profession', type: 'string', width: 175 },
  { field: 'city', headerName: 'City', type: 'string', width: 150 },
  { field: 'country', headerName: 'Country', type: 'string', width: 175 },
  {
    field: 'date_created',
